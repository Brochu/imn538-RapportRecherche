...
\subsubsection{Exemple 1 (maison simple)}
-- insérer img ex 1 --
...
\subsubsection{Exemple 2 (bloc d'édifices à bureaux)}
-- insérer img ex 2 --
...
\subsubsection{Exemple 3 (maison de banlieue)}
-- insérer img ex 3 --
...
-- insérer img quartier --
On peut aussi utiliser plusieurs maisons de ce type et les rassembler pour créer un quartier de banlieue.
